...
public class Game {
    ...
    public Game(int width, int height,Level level) {
        this.width = width;
        this.height = height;
        this.ball = new Ball(20,20,new Point2D(width/2,height/2),new Point2D(100,100), this);
        ...
        for(int i=0; i < this.player.getLives();i++){
            this.hearts.add(new Image("C:\\Users\\niaxd\\Pictures\\pong_projekt_JAVA\\Projekt-BreakOut\\src\\main\\resources\\Images\\heart.png"));
        }
    }
