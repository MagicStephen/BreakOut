...
public class LevelsController {
    ...
    public void initialize(){
        ...
        try (BufferedReader br = Files.newBufferedReader(Paths.get("C:\\Users\\Štěpán\\Desktop\\java-projekt\\BreakOut-cd5fd7ee5b5cbd8bbf3662b1a98c735e409d5345\\Projekt-BreakOut\\src\\main\\resources\\Levels\\levels.txt"))) {
        ...
        for(int i=0; i < listofLevels.length;i++){
            listofLevelsParsed.add(new Level(listofLevels[i]));
        }
    }
