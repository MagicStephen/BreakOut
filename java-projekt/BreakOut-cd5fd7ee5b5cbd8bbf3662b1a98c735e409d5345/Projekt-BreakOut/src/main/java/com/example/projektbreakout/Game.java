...
public class Game {
    ...
    public Game(int width, int height,Level level) {
        ...
        for(int i=0; i < this.player.getLives();i++){
            this.hearts.add(new Image("C:\\Users\\niaxd\\Desktop\\Nová složka (6)\\java-projekt\\BreakOut-cd5fd7ee5b5cbd8bbf3662b1a98c735e409d5345\\Projekt-BreakOut\\src\\main\\resources\\Images\\heart.png"));
        }
    }
